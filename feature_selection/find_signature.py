...
print features_train, features_test, labels_train, labels_test
...
for i in xrange(len(clf.feature_importances_)):
	if i == 0:
		...
		if clf.feature_importances_[i] > clf.feature_importances_[ft]:
			ft = i

print(ft, clf.feature_importances_[ft])